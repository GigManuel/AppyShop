...
use Appydo\ShopBundle\Entity\Product;
use Appydo\ShopBundle\Form\ProductType;
...
class ProductController extends Controller
{
     ...
     *
     * @Route("/", name="_appydo_admin_shop_product")
     * @Template()
     */
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppydoShopBundle:Product')->findAll();
     ...
     * @Method("post")
     * @Template("AppydoShopBundle:Product:new.html.twig")
     */
     ...
     *
     * @Route("/{id}/edit", name="_appydo_admin_shop_product_edit")
     * @Template()
     */
     ...
     * @Method("post")
     * @Template("AppydoShopBundle:Product:edit.html.twig")
     */
